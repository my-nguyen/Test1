package com.nguyen.test1.data.source
...
import com.nguyen.test1.data.source.local.TasksLocalDataSource
import com.nguyen.test1.data.source.local.ToDoDatabase
import com.nguyen.test1.data.source.remote.TasksRemoteDataSource
...
class DefaultTasksRepository private constructor(application: Application) {
    ...
    private suspend fun updateTasksFromRemoteDataSource() {
        ...
        if (remoteTasks is com.nguyen.test1.data.Result.Success) {
    ...
    suspend fun completeTask(taskId: String) {
        withContext(ioDispatcher) {
            (getTaskWithId(taskId) as? com.nguyen.test1.data.Result.Success)?.let { it ->
